...
export default function BigIslandPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative">
        ...
        <div className="absolute bottom-0 left-0 right-0 py-8 md:py-12 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <h1 className="text-5xl font-bold mb-4 text-white">Big Island</h1>
            <p className="text-xl opacity-90 text-emerald-100">The Island of Hawaiʻi</p>
      ...
      <FilteredCourseGrid courses={courses} islandColor="bg-orange-500" />
    </main>
  )
}
