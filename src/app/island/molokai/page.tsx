    ...
    <main className="min-h-screen bg-gray-50">
      <section className="bg-gradient-to-br from-[#0c4a6e] via-[#075985] to-[#0369a1] text-white py-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            Molokai Golf Courses
          </h1>
          <p className="text-emerald-100 text-lg max-w-2xl">
            {courses.length} course on the Friendly Isle. Authentic Hawaiian golfing experience.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 max-w-6xl mx-auto">
        ...
        {courses.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">Course data coming soon.</p>
          </div>
        )}
      </section>
    </main>
